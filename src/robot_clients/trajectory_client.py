...
class JTASPositionClient(object):
    """
    Class that creates a ROS Action client in order to make calls to execute a joint trajectory on the robot using the Joint Trajectory Action Service.
